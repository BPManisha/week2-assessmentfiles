...
var greetuser = (userName)=>{
    ...
    //checking that username is received here
    //console.log(userName)
    // returning back the desired string
    return("welcomeback" + userName + "!" );
}
// checking that return value is received here
console.log(greetuser('Lincoln,the new baby'))
...
const deliveryAreaZipCodes = [85205, 85204, 85203, 85213, 85206]
var canWeDeliver = (zipcode)=>{
    for (i=0; i<=deliveryAreaZipCodes.length;i++)
  { if (deliveryAreaZipCodes[i]=== zipcode)
  {
    console.log("Yes, You're in our delivery zone!")
...
// first input to check the zipcode is in the delivery range.
  canWeDeliver(84606)

// 2nd input value to check the zipcode is out of delivery range
canWeDeliver(85205)
